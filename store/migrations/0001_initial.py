# Generated by Django 4.0.6 on 2022-09-03 05:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='This is the name of the product', max_length=200, verbose_name='product name')),
                ('price', models.PositiveIntegerField(help_text='Any positive integer number')),
                ('description', models.TextField(max_length=10000, verbose_name='product description')),
                ('image_url', models.URLField(help_text='product image address', max_length=3000, verbose_name='image url')),
                ('discount', models.PositiveIntegerField(default=0)),
                ('product_uuid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='unique product identification number', verbose_name='product uuid')),
                ('date_added', models.DateField(auto_now_add=True, verbose_name='date added to store')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.trader')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveSmallIntegerField(choices=[(1, 1), (2, 2), (3, 4), (4, 4), (5, 5)], default=4, verbose_name='product_rating')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cart_products', to='store.cart')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.product')),
                ('wish_list', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='store.customerwishlist')),
            ],
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.AddField(
            model_name='product',
            name='subcategory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='store.subcategory'),
        ),
        migrations.AddField(
            model_name='product',
            name='trader',
            field=models.ForeignKey(help_text='product merchant', on_delete=django.db.models.deletion.CASCADE, related_name='trader_products', to='store.trader'),
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='store.order')),
            ],
        ),
        migrations.CreateModel(
