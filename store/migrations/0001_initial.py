# Generated by Django 3.2 on 2023-02-04 07:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='WishListProductInstance',
            fields=[
                ('product_uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.product')),
                ('wish_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.customerwishlist')),
            ],
        ),
        migrations.CreateModel(
            name='Trader',
